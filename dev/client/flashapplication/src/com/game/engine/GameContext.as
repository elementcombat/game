package com.game.engine
{
	...
	import com.geleca.as3.core.ObjectFactory;
	/**
	 * ...
	...
	public class GameContext extends Context
	{
		...
		public function GameContext() 
		{
			...
			this.add("garbage", 		new GarbageCollector());
		...
		*/
		...
		public function get garbage()			:GarbageCollector 		{ return this.getByName("garbageCollector"); }
